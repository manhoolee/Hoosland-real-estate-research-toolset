...
| 轴 | V0.2 当前值 | 说明 |
|---|---:|---|
| Application | `0.2.6` | 从前一线上 V0.2.5 scope-gate 精确派生，现已上线 V2 / slot-b |
...
V0.2.6 从线上 V0.2.5 scope-gate release 直接派生。Application 升至 `0.2.6`，增加对话 scope/egress 门禁及混合内部元数据刺探拦截；System Prompt、Skill bundle、Project state Schema、usage sidecar Schema 与 Run checklist sidecar Schema 均不变化，也不执行数据迁移。
